...
func run(logger *slog.Logger) error {
	...
	var (
		...
		captions  = flag.Bool("captions", false, "generate output captions.srt from raw.mp4 or voice.mp3")
		render    = flag.Bool("render", false, "render output raw.mp4 and final.mp4 when captions.srt exists")
